...
export function GoogleSignInButton() {
  ...
  {clientId && !clientSecret && <p className="text-[11px] text-amber-300 mt-1">Client Secret optional for native OAuth (PKCE). Set VITE_TAURA_GOOGLE_CLIENT_SECRET if required by your OAuth app.</p>}
